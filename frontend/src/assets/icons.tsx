...
// A collection of simple, inlined SVG icons to avoid extra file loads.
// Using `currentColor` for fill/stroke makes them easily themeable with Tailwind's text color utilities.
